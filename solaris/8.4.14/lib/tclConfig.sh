...
# build directory.
TCL_BUILD_LIB_SPEC='-L/local/Develop/develop/tcl8.4.14/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tmp/tcl/lib -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/local/Develop/develop/tcl8.4.14'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/local/Develop/develop/tcl8.4.14/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tmp/tcl/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/local/Develop/develop/tcl8.4.14/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tmp/tcl/lib/libtclstub8.4${TCL_DBGX}.a'
