...
#
# ActiveState ActiveTcl 8.4.14.0.272572 Win32/x86, Sun Nov 26 12:49:02 AM Pacific Standard Time 2006
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1164530942}
	buildtime,fmt {Sun Nov 26 12:49:02 AM Pacific Standard Time 2006}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.14.0.272572 Win32/x86 @ Sun Nov 26 12:49:02 AM Pacific Standard Time 2006 / normal}
    }
}

package provide {ActiveTcl} {8.4.14.0.272572}
...
if {![interp issafe] && ![catch {package require platform}]} {
    ...
    global __teapot
    set    __teapot {C:/Dokumente und Einstellungen/develop/Teapot/repository}
